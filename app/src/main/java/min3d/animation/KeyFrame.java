...
public class KeyFrame {
	...
	public void setIndices(int[] indices) {
		...
		vertices = new float[indices.length*3];//定义定点坐标--索引长度*3--（三角形3个顶点）
		int len = indices.length;
		int vi = 0;
		int ii = 0;
		int normalIndex = 0;//法线索引
	...
	public Number3d calculateFaceNormal(Number3d v1, Number3d v2, Number3d v3)//面法线
	{
